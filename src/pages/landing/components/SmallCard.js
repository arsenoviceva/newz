...
export const SmallCard = ({details, cardTitleColor, cardTitle, coloredTitle, badgeTitle, backgroundColor }) => {
    return (
        ...
        <Row>
            ...
            <Card className={backgroundColor}>
                        ...
                        {details &&  <div className="my-4 me-5 d-flex  align-items-center gap-2">
            ...
            <Col md={4}>
                <img src="/images/smallcard.jpg" className="w-100"/>
            </Col>
        </Row>
