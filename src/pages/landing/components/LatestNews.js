      ...
      <Row>
        <Col md={12}>
          <a href="/" className="text-decoration-none fs-20px">
            LATEST NEWS <SlArrowRight className="fs-20px" />{" "}
          </a>
        </Col>
        <Row className="my-4">
          ...
          <Col md={5} className="p-0 mt-md-0 mt-3 ps-md-3">
            <SmallCard
              badgeTitle={"NEWS"}
            ...
            <SmallCard
              ...
              cardTitleColor="fs-5 text-black"
              backgroundColor="bg-white"
              cardTitle={"Sadabell ATM become popular in Ohio"}
            />
            <hr />
            <SmallCard
              badgeTitle={"MARKET"}
              ...
              backgroundColor="bg-white"
              cardTitle={
                "US accuses Russia of currency manipulation. What did Putin said?"
              }
            />
            <hr />
            <a href="/" className="text-decoration-none fs-20px">
