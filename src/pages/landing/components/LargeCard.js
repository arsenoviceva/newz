    ...
    <Card className=" mt-3">
      ...
      <Card.Body className="px-0">
        ...
        <Card.Text className="pt-3">
          ...
          conversations with the AI, which he called a "person", but Google said
          the evidence doesn't [...]
          <div className="my-4 me-md-5 me-1 d-flex  align-items-center gap-2">
            <LiaCalendarAlt className="fs-5" /> Dec 14, 2022
            {isUser && (
              <>
                <LiaUserSolid className="fs-5 ms-md-4" /> By{" "}
                <strong>Admin</strong>
              </>
            )}
